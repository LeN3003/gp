...
public class PlayerController : MonoBehaviour
{
    ...
    private float lastWallJumpedDirection;
  ...
  //  public Vector3[] ladderPositions;  // Array of ladder positions
  //  public GameObject ladderPrefab;    // Ladder prefab to instantiate
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        */
        ...
        if (other.gameObject.CompareTag("Coin"))
        {
            ...
            {
                CoinManager.Instance.IncreaseCoinCount(1);
            }
            else
            {
        ...
        if (other.gameObject.CompareTag("Key"))
        {
            ...
            if (CoinManager.Instance != null)
            {
                CoinManager.Instance.IncreaseKeyCount(1);
            }
            else
            {
                Debug.LogError("CoinManager instance is null.");
